...
DUnitFrames:AddTrans("zhCN", "LID_GENERAL", "常规")
DUnitFrames:AddTrans("zhCN", "LID_MMBTN", "小地图按钮")
DUnitFrames:AddTrans("zhCN", "LID_PORTRAIT", "头像")
DUnitFrames:AddTrans("zhCN", "LID_BARS", "状态条")
DUnitFrames:AddTrans("zhCN", "LID_BORDER", "边框")
DUnitFrames:AddTrans("zhCN", "LID_TEXT", "文本")
DUnitFrames:AddTrans("zhCN", "LID_NAME", "名称")
DUnitFrames:AddTrans("zhCN", "LID_VALUES", "数值")
DUnitFrames:AddTrans("zhCN", "LID_PLAYERFRAME", "玩家框体")
DUnitFrames:AddTrans("zhCN", "LID_TARGETFRAME", "目标与焦点框体")
